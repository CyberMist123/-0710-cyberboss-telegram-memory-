...
If {{USER_NAME}} explicitly wants a Chinese timeline dashboard or screenshot, use Chinese. Keep the locale consistent across timeline build, serve, dev, and screenshot work for the same task.
